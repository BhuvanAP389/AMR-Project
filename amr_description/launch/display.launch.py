...
def generate_launch_description():
    ...
    model_arg = DeclareLaunchArgument(name="model1",default_value=os.path.join(amr_description_dir,"urdf","amr.urdf.xacro"), description="Absolute path to robot urdf file")
    ...
    robot_description = ParameterValue(
        Command(["xacro ", LaunchConfiguration("model1")]), value_type=str
    )
